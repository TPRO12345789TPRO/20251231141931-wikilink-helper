...
2. Locate `wikilink-helper-1.3.0.zip` in the `dist/` folder. (Our build script generates this alongside the CRX).
...
## 3. Upload Your Item
1. Click **+ New Item**.
2. Click **Browse files** and select `dist/wikilink-helper-1.3.0.zip`.
